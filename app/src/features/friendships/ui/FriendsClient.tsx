    ...
    <div className="page-shell">
      ...
      <div className="grid gap-6 xl:grid-cols-[minmax(0,0.92fr)_minmax(0,1.08fr)]">
              ...
              <ul className="space-y-2">
                {requests.map((request) => {
                  ...
                  return (
                    <li
                      key={request.id}
                      className="flex flex-col gap-3 rounded-[var(--radius-lg)] border border-[color:var(--color-border)] bg-white/70 p-4 sm:flex-row sm:items-center sm:justify-between"
                    >
                      <div className="flex items-center gap-3">
                        <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-[rgba(191,90,60,0.14)] text-sm font-semibold text-[color:var(--color-accent)]">
        ...
        <SurfaceCard className="space-y-4">
          ...
          {friends.length === 0 ? (
            <div className="empty-state rounded-[var(--radius-lg)] border border-dashed border-[color:var(--color-border)] bg-white/70">
            ...
            <ul className="space-y-4">
              {friends.map((friend) => {
                ...
                return (
                  <li
                    key={friend.id}
                    className="rounded-[var(--radius-lg)] border border-[color:var(--color-border)] bg-white/70 p-4 shadow-[0_8px_24px_rgba(54,39,24,0.06)]"
                  >
                    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                      <div className="flex items-center gap-3">
                        <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[rgba(191,90,60,0.14)] text-sm font-semibold text-[color:var(--color-accent)]">
